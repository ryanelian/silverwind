...
const StyledDiv = React.forwardRef((props: React.ComponentPropsWithoutRef<"div">, ref: React.ComponentProps<"div">["ref"]) => {
  return <div className="bg-[#f0f0f0] p-[20px]" ref={ref} {...props}>
                {props.children}
            </div>;
});
...
const StyledButton = React.forwardRef((props: React.ComponentPropsWithoutRef<"button">, ref: React.ComponentProps<"button">["ref"]) => {
  return <button className="bg-[#007bff] text-white cursor-pointer text-[16px] transition-[background-color] duration-[0.3s] ease-[ease] px-[20px] py-[10px] rounded-[5px] border-[none] hover:bg-[#0056b3]" ref={ref} {...props}>
                {props.children}
            </button>;
});
...
const SemanticRedSpan = React.forwardRef((props: React.ComponentPropsWithoutRef<"span">, ref: React.ComponentProps<"span">["ref"]) => {
  return <span className="text-[#bf2641] bg-[#02823D]" ref={ref} {...props}>
                {props.children}
            </span>;
});
